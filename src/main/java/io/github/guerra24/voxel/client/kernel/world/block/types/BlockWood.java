...
public class BlockWood extends IBlock {
	...
	public BlockEntity getFaceUp(Vector3f pos) {
		return new BlockEntity(BlocksResources.cubeWoodUP, pos, 0, 0, 0, 1);
	}

	@Override
	public BlockEntity getFaceDown(Vector3f pos) {
		return new BlockEntity(BlocksResources.cubeWoodDOWN, pos, 0, 0, 0, 1);
	}

	@Override
	public BlockEntity getFaceEast(Vector3f pos) {
		return new BlockEntity(BlocksResources.cubeWoodEAST, pos, 0, 0, 0, 1);
	}

	@Override
	public BlockEntity getFaceWest(Vector3f pos) {
		return new BlockEntity(BlocksResources.cubeWoodWEST, pos, 0, 0, 0, 1);
	}

	@Override
	public BlockEntity getFaceNorth(Vector3f pos) {
		return new BlockEntity(BlocksResources.cubeWoodNORTH, pos, 0, 0, 0, 1);
	}

	@Override
	public BlockEntity getFaceSouth(Vector3f pos) {
		return new BlockEntity(BlocksResources.cubeWoodSOUTH, pos, 0, 0, 0, 1);
	}
