...
public class Display {
	...
	private static org.lwjgl.opengl.GLCapabilities context;
	...
	static {
		...
		int monitorBitPerPixel = GLFWvidmode.redBits(vidmode)
				+ GLFWvidmode.greenBits(vidmode)
				+ GLFWvidmode.blueBits(vidmode);
		int monitorRefreshRate = GLFWvidmode.refreshRate(vidmode);

		desktopDisplayMode = new DisplayMode(monitorWidth, monitorHeight,
				monitorBitPerPixel, monitorRefreshRate);
	}

	public static void create(PixelFormat pixel_format, Drawable shared_drawable)
			throws LWJGLException {
		System.out
				.println("TODO: Implement Display.create(PixelFormat, Drawable)"); // TODO
		create();
	}
	...
	public static void create(PixelFormat pixel_format, ContextAttribs attribs)
			throws LWJGLException {
		System.out
				.println("TODO: Implement Display.create(PixelFormat, ContextAttribs)"); // TODO
		create();
	}
	...
	public static void create() throws LWJGLException {
		...
		Window.handle = glfwCreateWindow(mode.getWidth(), mode.getHeight(),
		...
		glfwSetWindowPos(Window.handle, (monitorWidth - mode.getWidth()) / 2,
		...
		context = org.lwjgl.opengl.GL.createCapabilities();
	...
	public static org.lwjgl.opengl.GLCapabilities getContext() {
		return context;
	}
	...
	public static DisplayMode[] getAvailableDisplayModes()
		...
		ByteBuffer modes = GLFW.glfwGetVideoModes(GLFW.glfwGetPrimaryMonitor(),
				count);
	...
	public static void setInitialBackground(float red, float green, float blue) {
		// TODO
		System.out
				.println("TODO: Implement Display.setInitialBackground(float, float, float)");
	}
	...
	public static void setDisplayModeAndFullscreen(DisplayMode mode)
		...
		// TODO
		System.out
				.println("TODO: Implement Display.setDisplayModeAndFullscreen(DisplayMode)");
	}
