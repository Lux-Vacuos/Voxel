package net.guerra24.voxel.client.rendering.api.vulkan;
...
public class VkUtil {
	...
	public static boolean getMemoryType(VkPhysicalDeviceMemoryProperties deviceMemoryProperties, int typeBits,
			int properties, IntBuffer typeIndex) {
		int tb = typeBits;
		for (int i = 0; i < 32; i++) {
			if ((tb & 1) == 1) {
