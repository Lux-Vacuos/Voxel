...
public class GLCaps {
	public static void checkGLCaps() {
		...
		if(GLContext.getCapabilities().OpenGL11) {
			...
			Logger.log("OpenGL 1.1 is not supported");
			System.exit(0);
		}
		if(GLContext.getCapabilities().OpenGL12) {
			...
			Logger.log("OpenGL 1.2 is not supported");
			System.exit(0);
		}
