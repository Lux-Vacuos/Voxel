...
public class GameSP {
		...
		if (VoxelVariables.debug) {
			UIRendering.renderText(
					"Voxel " + " (" + VoxelVariables.version + ")" + " Molten API" + " (" + MoltenAPI.apiVersion + "/"
							+ MoltenAPI.build + ")",
					"Roboto-Bold", 5, 12, 20, UIRendering.rgba(160, 160, 160, 200, UIRendering.colorA),
			...
			UIRendering.renderText("Used VRam: " + gm.getDisplay().getUsedVRAM() + "KB " + " UPS: " + CoreInfo.ups,
					"Roboto-Bold", 5, 95, 20, UIRendering.rgba(160, 160, 160, 200, UIRendering.colorA),
					UIRendering.rgba(255, 255, 255, 255, UIRendering.colorB));
			UIRendering.renderText(
					"Loaded Chunks: " + world.getLoadedChunks() + "   Rendered Chunks: " + world.getRenderedChunks(),
					"Roboto-Bold", 5, 115, 20, UIRendering.rgba(160, 160, 160, 200, UIRendering.colorA),
					UIRendering.rgba(255, 255, 255, 255, UIRendering.colorB));
			UIRendering.renderText(
					"Position XYZ:  " + gm.getCamera().getPosition().getX() + "  " + gm.getCamera().getPosition().getY()
							+ "  " + gm.getCamera().getPosition().getZ(),
					"Roboto-Bold", 5, 135, 20, UIRendering.rgba(160, 160, 160, 200, UIRendering.colorA),
					UIRendering.rgba(255, 255, 255, 255, UIRendering.colorB));
			UIRendering.renderText(
					"Pitch:  " + gm.getCamera().getPitch() + "   Yaw: " + gm.getCamera().getYaw() + "   Roll: "
							+ gm.getCamera().getRoll(),
					"Roboto-Bold", 5, 155, 20, UIRendering.rgba(160, 160, 160, 200, UIRendering.colorA),
					UIRendering.rgba(255, 255, 255, 255, UIRendering.colorB));
	...
	private void renderHud(GameResources gm) {
		...
		UIRendering.renderBox(x - 8, y - 8, w, h,
				UIRendering.rgba(255, 255, 255, 200, UIRendering.colorA),
				UIRendering.rgba(32, 32, 32, 32, UIRendering.colorB),
