...
import static net.luxvacuos.voxel.client.rendering.api.nanovg.VectorsRendering.colorA;
import static net.luxvacuos.voxel.client.rendering.api.nanovg.VectorsRendering.rgba;
