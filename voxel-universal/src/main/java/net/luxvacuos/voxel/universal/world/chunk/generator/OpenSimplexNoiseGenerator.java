...
/*
 * OpenSimplex Noise in Java, version 1.1
 * by Kurt Spencer
 * Modified by Jacob Litewski for Voxel
 */
public class OpenSimplexNoiseGenerator implements INoiseGenerator {
	...
	public OpenSimplexNoiseGenerator(short[] perm) {
		if(perm.length != 256) throw new IllegalStateException("Perm size HAS to be 256 long!");
